...
if __name__=="__main__":
    # !!!!!!!!!!!!!!!!-----更换每个月的表--company_ad_20200803
    table_ad = "company_ad_20200901"
    sql_prame = {
        "host": "192.168.0.227",
        "db": "oridata",
        "user": "dev",
    ...
    # !!!!!!!!!!!!!!!!-----更换每个月的表：一：company_qichacha_202007    二：company_qichacha_202007_add
    table_qichacha = "company_qichacha_202008"

    # !!!!!!!!!!!!!!!!-----自动创建每个月的表--company_ad_diff_20200804
    dif_table = "company_ad_diff_20200904"
    ...
    for i in tqdm(dif_data):
        ...
        for j in dif_list:
            ...
            # sql_insert = sql_insert.format(pymysql.escape_string((j.strip()),company,info[0],info[1],info[2],info[3]))
            try:
