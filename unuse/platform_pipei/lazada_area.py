...
if __name__ == "__main__":
    match_task = p_pipei()
    match_task.get_address("浙江中文")#中文addres，浙江中文

    connect_get = match_task.creat_connect()
    cursor_get = connect_get.cursor()

    sql_get = 'SELECT location,index_id from lazada_shopinfo_201912'
    sql_update = '''update lazada_shopinfo_201912 set province_match = "{}",city_match = "{}",area_match = "{}",match_confidence="{}" where index_id = "{}";'''
