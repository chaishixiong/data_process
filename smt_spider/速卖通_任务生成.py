...
class CreateTask(object):
    def __init__(self):
        ...
        self.connect = pymysql.connect(host='192.168.1.4', port=3306, database='ec_cross_border', user='update_all',
                                       password='123456',
        ...
        # self.name = open(r'X:\数据库\速卖通\seed\shop_id.txt', 'w', encoding='utf-8')

    def get_shop_id(self, table):
        self.cursor.execute("""SELECT shop_id FROM `smt_shopinfo_202212_new` WHERE `sales_month` <> '' AND `shui_id` = ''""".format(table))
